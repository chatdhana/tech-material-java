/* 
 * @(#)DeleteObjectClass.java	1.4 01/05/24
 * 
...
/**
  * Demonstrates how to remove an object class from the schema.
  *
  * usage: java DeleteObjectClass
  */
class DeleteObjectClass {
	...
	// This is required for using with Netscape Directory Server 3.x
