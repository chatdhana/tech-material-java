/* 
 * @(#)DeleteAttributeDefn.java	1.4 01/05/24
 * 
...
/**
  * Demonstrates how to remove an attribute definition from the schema.
  *
  * usage: java DeleteAttributeDefn
  */
class DeleteAttributeDefn {
