...
/**
  * Demonstrates how to handle exceptions that occur after listener registration.
  *
  * usage: java Exception
  */
class Exception {
	...
	try {
	    ...
	    // Register listener for namespace change events of nonexistent object
	    ctx.addNamingListener("ou=NotThere,cn=Rosanna Lee", 
