 ...
 */
public class MessageDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements atlas.pubsub.xmlbeans.le.MessageDocument
{
     ...
     * This is a complex type.
     */
    public static class MessageImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements atlas.pubsub.xmlbeans.le.MessageDocument.Message
    {
        private static final long serialVersionUID = 1L;
        ...
        public atlas.pubsub.xmlbeans.le.TransactionProcessingSystemsDocument.TransactionProcessingSystems getTransactionProcessingSystems()
        {
            synchronized (monitor())
            {
                ...
                target = (atlas.pubsub.xmlbeans.le.TransactionProcessingSystemsDocument.TransactionProcessingSystems)get_store().find_element_user(TRANSACTIONPROCESSINGSYSTEMS$12, 0);
                if (target == null)
                {
                    return null;
                }
        ...
        public atlas.pubsub.xmlbeans.le.TransactionProcessingSystemsDocument.TransactionProcessingSystems addNewTransactionProcessingSystems()
        {
            synchronized (monitor())
            {
                check_orphaned();
                atlas.pubsub.xmlbeans.le.TransactionProcessingSystemsDocument.TransactionProcessingSystems target = null;
                target = (atlas.pubsub.xmlbeans.le.TransactionProcessingSystemsDocument.TransactionProcessingSystems)get_store().add_element_user(TRANSACTIONPROCESSINGSYSTEMS$12);
                return target;
            }
        }
    }
