 ...
 */
package com.scb.sci.s2b.impl;
/**
 * A document containing one TPCustRequest(@) element.
 *
 * This is a complex type.
 */
public class TPCustRequestDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.s2b.TPCustRequestDocument
{
     ...
     */
    public com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest getTPCustRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest target = null;
            target = (com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest)get_store().find_element_user(TPCUSTREQUEST$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setTPCustRequest(com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest tpCustRequest)
    {
     ...
     */
    public com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest addNewTPCustRequest()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest target = null;
            target = (com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest)get_store().add_element_user(TPCUSTREQUEST$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class TPCustRequestImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest
    {
        private static final long serialVersionUID = 1L;
         ...
         */
        public com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails[] getRequestedSystemDetailsArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails[] result = new com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails[targetList.size()];
         ...
         */
        public com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails getRequestedSystemDetailsArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails target = null;
                target = (com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails)get_store().find_element_user(REQUESTEDSYSTEMDETAILS$6, i);
                if (target == null)
                {
         ...
         */
        public void setRequestedSystemDetailsArray(com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails[] requestedSystemDetailsArray)
        {
            check_orphaned();
         ...
         */
        public void setRequestedSystemDetailsArray(int i, com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails requestedSystemDetails)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails insertNewRequestedSystemDetails(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails target = null;
                target = (com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails)get_store().insert_element_user(REQUESTEDSYSTEMDETAILS$6, i);
                return target;
            }
        }
         ...
         */
        public com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails addNewRequestedSystemDetails()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails target = null;
                target = (com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails)get_store().add_element_user(REQUESTEDSYSTEMDETAILS$6);
                return target;
            }
        }
         ...
         * This is a complex type.
         */
        public static class RequestedSystemDetailsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.s2b.TPCustRequestDocument.TPCustRequest.RequestedSystemDetails
        {
            private static final long serialVersionUID = 1L;
