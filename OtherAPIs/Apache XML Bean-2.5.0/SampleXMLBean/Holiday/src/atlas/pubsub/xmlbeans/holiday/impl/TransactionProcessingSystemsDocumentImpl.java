 ...
 */
public class TransactionProcessingSystemsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements atlas.pubsub.xmlbeans.holiday.TransactionProcessingSystemsDocument
{
    ...
    public atlas.pubsub.xmlbeans.holiday.TransactionProcessingSystemsDocument.TransactionProcessingSystems getTransactionProcessingSystems()
    {
        synchronized (monitor())
        {
            ...
            target = (atlas.pubsub.xmlbeans.holiday.TransactionProcessingSystemsDocument.TransactionProcessingSystems)get_store().find_element_user(TRANSACTIONPROCESSINGSYSTEMS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public atlas.pubsub.xmlbeans.holiday.TransactionProcessingSystemsDocument.TransactionProcessingSystems addNewTransactionProcessingSystems()
    {
        synchronized (monitor())
        {
            check_orphaned();
            atlas.pubsub.xmlbeans.holiday.TransactionProcessingSystemsDocument.TransactionProcessingSystems target = null;
            target = (atlas.pubsub.xmlbeans.holiday.TransactionProcessingSystemsDocument.TransactionProcessingSystems)get_store().add_element_user(TRANSACTIONPROCESSINGSYSTEMS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class TransactionProcessingSystemsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements atlas.pubsub.xmlbeans.holiday.TransactionProcessingSystemsDocument.TransactionProcessingSystems
    {
        private static final long serialVersionUID = 1L;
