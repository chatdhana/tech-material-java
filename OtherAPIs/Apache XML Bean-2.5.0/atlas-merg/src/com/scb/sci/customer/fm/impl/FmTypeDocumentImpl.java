 ...
 */
public class FmTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.FmTypeDocument
{
    private static final long serialVersionUID = 1L;
    
    public FmTypeDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName FMTYPE$0 = 
    ...
    public com.scb.sci.customer.fm.FmTypeDocument.FmType getFmType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.FmTypeDocument.FmType)get_store().find_element_user(FMTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(fmType, FMTYPE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.FmTypeDocument.FmType addNewFmType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.FmTypeDocument.FmType target = null;
            target = (com.scb.sci.customer.fm.FmTypeDocument.FmType)get_store().add_element_user(FMTYPE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class FmTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.FmTypeDocument.FmType
    {
        private static final long serialVersionUID = 1L;
        
        public FmTypeImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
