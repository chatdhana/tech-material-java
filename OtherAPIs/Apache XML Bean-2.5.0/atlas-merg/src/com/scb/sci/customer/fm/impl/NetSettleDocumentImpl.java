 ...
 */
public class NetSettleDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.NetSettleDocument
{
    ...
    public com.scb.sci.customer.fm.NetSettleDocument.NetSettle getNetSettle()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.NetSettleDocument.NetSettle)get_store().find_element_user(NETSETTLE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(netSettle, NETSETTLE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.NetSettleDocument.NetSettle addNewNetSettle()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.NetSettleDocument.NetSettle target = null;
            target = (com.scb.sci.customer.fm.NetSettleDocument.NetSettle)get_store().add_element_user(NETSETTLE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class NetSettleImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.NetSettleDocument.NetSettle
    {
        private static final long serialVersionUID = 1L;
        
        public NetSettleImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
