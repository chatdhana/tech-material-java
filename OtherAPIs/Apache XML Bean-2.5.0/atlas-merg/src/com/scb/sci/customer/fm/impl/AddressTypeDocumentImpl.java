 ...
 */
public class AddressTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.AddressTypeDocument
{
    ...
    public com.scb.sci.customer.fm.AddressTypeDocument.AddressType getAddressType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.AddressTypeDocument.AddressType)get_store().find_element_user(ADDRESSTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.scb.sci.customer.fm.AddressTypeDocument.AddressType addNewAddressType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.AddressTypeDocument.AddressType target = null;
            target = (com.scb.sci.customer.fm.AddressTypeDocument.AddressType)get_store().add_element_user(ADDRESSTYPE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class AddressTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.AddressTypeDocument.AddressType
    {
        private static final long serialVersionUID = 1L;
