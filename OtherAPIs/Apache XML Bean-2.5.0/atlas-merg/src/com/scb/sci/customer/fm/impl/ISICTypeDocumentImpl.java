 ...
 */
public class ISICTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ISICTypeDocument
{
    private static final long serialVersionUID = 1L;
    
    public ISICTypeDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ISICTYPE$0 = 
    ...
    public com.scb.sci.customer.fm.ISICTypeDocument.ISICType getISICType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.ISICTypeDocument.ISICType)get_store().find_element_user(ISICTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(isicType, ISICTYPE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.ISICTypeDocument.ISICType addNewISICType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.ISICTypeDocument.ISICType target = null;
            target = (com.scb.sci.customer.fm.ISICTypeDocument.ISICType)get_store().add_element_user(ISICTYPE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ISICTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ISICTypeDocument.ISICType
    {
        private static final long serialVersionUID = 1L;
