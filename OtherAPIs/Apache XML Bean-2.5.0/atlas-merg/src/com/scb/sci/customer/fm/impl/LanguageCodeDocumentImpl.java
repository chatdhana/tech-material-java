 ...
 */
public class LanguageCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.LanguageCodeDocument
{
    ...
    public com.scb.sci.customer.fm.LanguageCodeDocument.LanguageCode getLanguageCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.LanguageCodeDocument.LanguageCode)get_store().find_element_user(LANGUAGECODE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.scb.sci.customer.fm.LanguageCodeDocument.LanguageCode addNewLanguageCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.LanguageCodeDocument.LanguageCode target = null;
            target = (com.scb.sci.customer.fm.LanguageCodeDocument.LanguageCode)get_store().add_element_user(LANGUAGECODE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class LanguageCodeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.LanguageCodeDocument.LanguageCode
    {
        private static final long serialVersionUID = 1L;
