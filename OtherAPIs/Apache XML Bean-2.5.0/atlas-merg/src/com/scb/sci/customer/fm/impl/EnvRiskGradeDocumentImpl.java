 ...
 */
public class EnvRiskGradeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.EnvRiskGradeDocument
{
    private static final long serialVersionUID = 1L;
    
    public EnvRiskGradeDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName ENVRISKGRADE$0 = 
    ...
    public com.scb.sci.customer.fm.EnvRiskGradeDocument.EnvRiskGrade getEnvRiskGrade()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.EnvRiskGradeDocument.EnvRiskGrade)get_store().find_element_user(ENVRISKGRADE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(envRiskGrade, ENVRISKGRADE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.EnvRiskGradeDocument.EnvRiskGrade addNewEnvRiskGrade()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.EnvRiskGradeDocument.EnvRiskGrade target = null;
            target = (com.scb.sci.customer.fm.EnvRiskGradeDocument.EnvRiskGrade)get_store().add_element_user(ENVRISKGRADE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class EnvRiskGradeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.EnvRiskGradeDocument.EnvRiskGrade
    {
        private static final long serialVersionUID = 1L;
