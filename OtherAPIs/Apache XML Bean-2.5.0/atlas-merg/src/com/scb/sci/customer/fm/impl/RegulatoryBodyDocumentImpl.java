 ...
 */
public class RegulatoryBodyDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.RegulatoryBodyDocument
{
    private static final long serialVersionUID = 1L;
    
    public RegulatoryBodyDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName REGULATORYBODY$0 = 
    ...
    public com.scb.sci.customer.fm.RegulatoryBodyDocument.RegulatoryBody getRegulatoryBody()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.RegulatoryBodyDocument.RegulatoryBody)get_store().find_element_user(REGULATORYBODY$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(regulatoryBody, REGULATORYBODY$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.RegulatoryBodyDocument.RegulatoryBody addNewRegulatoryBody()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.RegulatoryBodyDocument.RegulatoryBody target = null;
            target = (com.scb.sci.customer.fm.RegulatoryBodyDocument.RegulatoryBody)get_store().add_element_user(REGULATORYBODY$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class RegulatoryBodyImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.RegulatoryBodyDocument.RegulatoryBody
    {
        private static final long serialVersionUID = 1L;
