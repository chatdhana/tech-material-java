 ...
 */
public class TreaturyIndDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.TreaturyIndDocument
{
    private static final long serialVersionUID = 1L;
    
    public TreaturyIndDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName TREATURYIND$0 = 
    ...
    public com.scb.sci.customer.fm.TreaturyIndDocument.TreaturyInd getTreaturyInd()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.TreaturyIndDocument.TreaturyInd)get_store().find_element_user(TREATURYIND$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(treaturyInd, TREATURYIND$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.TreaturyIndDocument.TreaturyInd addNewTreaturyInd()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.TreaturyIndDocument.TreaturyInd target = null;
            target = (com.scb.sci.customer.fm.TreaturyIndDocument.TreaturyInd)get_store().add_element_user(TREATURYIND$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class TreaturyIndImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.TreaturyIndDocument.TreaturyInd
    {
        private static final long serialVersionUID = 1L;
