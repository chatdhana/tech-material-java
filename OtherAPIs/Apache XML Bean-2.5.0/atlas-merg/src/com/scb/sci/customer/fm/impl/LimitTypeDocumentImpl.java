 ...
 */
public class LimitTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.LimitTypeDocument
{
    private static final long serialVersionUID = 1L;
    
    public LimitTypeDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName LIMITTYPE$0 = 
    ...
    public com.scb.sci.customer.fm.LimitTypeDocument.LimitType getLimitType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.LimitTypeDocument.LimitType)get_store().find_element_user(LIMITTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(limitType, LIMITTYPE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.LimitTypeDocument.LimitType addNewLimitType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.LimitTypeDocument.LimitType target = null;
            target = (com.scb.sci.customer.fm.LimitTypeDocument.LimitType)get_store().add_element_user(LIMITTYPE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class LimitTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.LimitTypeDocument.LimitType
    {
        private static final long serialVersionUID = 1L;
