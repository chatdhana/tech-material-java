 ...
 */
public class InstSectorDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.InstSectorDocument
{
    ...
    public com.scb.sci.customer.fm.InstSectorDocument.InstSector getInstSector()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.InstSectorDocument.InstSector)get_store().find_element_user(INSTSECTOR$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(instSector, INSTSECTOR$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.InstSectorDocument.InstSector addNewInstSector()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.InstSectorDocument.InstSector target = null;
            target = (com.scb.sci.customer.fm.InstSectorDocument.InstSector)get_store().add_element_user(INSTSECTOR$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class InstSectorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.InstSectorDocument.InstSector
    {
        private static final long serialVersionUID = 1L;
        
        public InstSectorImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
