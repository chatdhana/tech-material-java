 ...
 */
public class BaselCustomerSegmentDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.BaselCustomerSegmentDocument
{
    private static final long serialVersionUID = 1L;
    
    public BaselCustomerSegmentDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName BASELCUSTOMERSEGMENT$0 = 
    ...
    public com.scb.sci.customer.fm.BaselCustomerSegmentDocument.BaselCustomerSegment getBaselCustomerSegment()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.BaselCustomerSegmentDocument.BaselCustomerSegment)get_store().find_element_user(BASELCUSTOMERSEGMENT$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(baselCustomerSegment, BASELCUSTOMERSEGMENT$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.BaselCustomerSegmentDocument.BaselCustomerSegment addNewBaselCustomerSegment()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.BaselCustomerSegmentDocument.BaselCustomerSegment target = null;
            target = (com.scb.sci.customer.fm.BaselCustomerSegmentDocument.BaselCustomerSegment)get_store().add_element_user(BASELCUSTOMERSEGMENT$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class BaselCustomerSegmentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.BaselCustomerSegmentDocument.BaselCustomerSegment
    {
        private static final long serialVersionUID = 1L;
