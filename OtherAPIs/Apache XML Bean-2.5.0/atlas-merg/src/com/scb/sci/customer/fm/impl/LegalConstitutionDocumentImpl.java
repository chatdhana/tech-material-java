 ...
 */
public class LegalConstitutionDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.LegalConstitutionDocument
{
    private static final long serialVersionUID = 1L;
    
    public LegalConstitutionDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName LEGALCONSTITUTION$0 = 
    ...
    public com.scb.sci.customer.fm.LegalConstitutionDocument.LegalConstitution getLegalConstitution()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.LegalConstitutionDocument.LegalConstitution)get_store().find_element_user(LEGALCONSTITUTION$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(legalConstitution, LEGALCONSTITUTION$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.LegalConstitutionDocument.LegalConstitution addNewLegalConstitution()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.LegalConstitutionDocument.LegalConstitution target = null;
            target = (com.scb.sci.customer.fm.LegalConstitutionDocument.LegalConstitution)get_store().add_element_user(LEGALCONSTITUTION$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class LegalConstitutionImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.LegalConstitutionDocument.LegalConstitution
    {
        private static final long serialVersionUID = 1L;
