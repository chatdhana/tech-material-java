 ...
 */
public class SymbologyDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.SymbologyDocument
{
    private static final long serialVersionUID = 1L;
    
    public SymbologyDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName SYMBOLOGY$0 = 
    ...
    public com.scb.sci.customer.fm.SymbologyDocument.Symbology getSymbology()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.SymbologyDocument.Symbology)get_store().find_element_user(SYMBOLOGY$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(symbology, SYMBOLOGY$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.SymbologyDocument.Symbology addNewSymbology()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.SymbologyDocument.Symbology target = null;
            target = (com.scb.sci.customer.fm.SymbologyDocument.Symbology)get_store().add_element_user(SYMBOLOGY$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class SymbologyImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.SymbologyDocument.Symbology
    {
        private static final long serialVersionUID = 1L;
        
        public SymbologyImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
