 ...
 */
public class FmTradingAccountTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.FmTradingAccountTypeDocument
{
    private static final long serialVersionUID = 1L;
    
    public FmTradingAccountTypeDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName FMTRADINGACCOUNTTYPE$0 = 
    ...
    public com.scb.sci.customer.fm.FmTradingAccountTypeDocument.FmTradingAccountType getFmTradingAccountType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.FmTradingAccountTypeDocument.FmTradingAccountType)get_store().find_element_user(FMTRADINGACCOUNTTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(fmTradingAccountType, FMTRADINGACCOUNTTYPE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.FmTradingAccountTypeDocument.FmTradingAccountType addNewFmTradingAccountType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.FmTradingAccountTypeDocument.FmTradingAccountType target = null;
            target = (com.scb.sci.customer.fm.FmTradingAccountTypeDocument.FmTradingAccountType)get_store().add_element_user(FMTRADINGACCOUNTTYPE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class FmTradingAccountTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.FmTradingAccountTypeDocument.FmTradingAccountType
    {
        private static final long serialVersionUID = 1L;
        
        public FmTradingAccountTypeImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
