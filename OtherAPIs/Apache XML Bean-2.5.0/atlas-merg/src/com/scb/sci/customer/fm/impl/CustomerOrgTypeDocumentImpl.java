 ...
 */
public class CustomerOrgTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.CustomerOrgTypeDocument
{
    private static final long serialVersionUID = 1L;
    
    public CustomerOrgTypeDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName CUSTOMERORGTYPE$0 = 
    ...
    public com.scb.sci.customer.fm.CustomerOrgTypeDocument.CustomerOrgType getCustomerOrgType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.CustomerOrgTypeDocument.CustomerOrgType)get_store().find_element_user(CUSTOMERORGTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(customerOrgType, CUSTOMERORGTYPE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.CustomerOrgTypeDocument.CustomerOrgType addNewCustomerOrgType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.CustomerOrgTypeDocument.CustomerOrgType target = null;
            target = (com.scb.sci.customer.fm.CustomerOrgTypeDocument.CustomerOrgType)get_store().add_element_user(CUSTOMERORGTYPE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class CustomerOrgTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.CustomerOrgTypeDocument.CustomerOrgType
    {
        private static final long serialVersionUID = 1L;
