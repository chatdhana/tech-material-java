 ...
 */
public class FinInstTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.FinInstTypeDocument
{
    ...
    public com.scb.sci.customer.fm.FinInstTypeDocument.FinInstType getFinInstType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.FinInstTypeDocument.FinInstType)get_store().find_element_user(FININSTTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(finInstType, FININSTTYPE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.FinInstTypeDocument.FinInstType addNewFinInstType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.FinInstTypeDocument.FinInstType target = null;
            target = (com.scb.sci.customer.fm.FinInstTypeDocument.FinInstType)get_store().add_element_user(FININSTTYPE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class FinInstTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.FinInstTypeDocument.FinInstType
    {
        private static final long serialVersionUID = 1L;
        
        public FinInstTypeImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
