 ...
 */
public class ExtrnlSystmCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ExtrnlSystmCodeDocument
{
    ...
    public com.scb.sci.customer.fm.ExtrnlSystmCodeDocument.ExtrnlSystmCode getExtrnlSystmCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.ExtrnlSystmCodeDocument.ExtrnlSystmCode)get_store().find_element_user(EXTRNLSYSTMCODE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(extrnlSystmCode, EXTRNLSYSTMCODE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.ExtrnlSystmCodeDocument.ExtrnlSystmCode addNewExtrnlSystmCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.ExtrnlSystmCodeDocument.ExtrnlSystmCode target = null;
            target = (com.scb.sci.customer.fm.ExtrnlSystmCodeDocument.ExtrnlSystmCode)get_store().add_element_user(EXTRNLSYSTMCODE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ExtrnlSystmCodeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ExtrnlSystmCodeDocument.ExtrnlSystmCode
    {
        private static final long serialVersionUID = 1L;
        
        public ExtrnlSystmCodeImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
