 ...
 */
public class OperationStatus1DocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.OperationStatus1Document
{
    private static final long serialVersionUID = 1L;
    
    public OperationStatus1DocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName OPERATIONSTATUS1$0 = 
    ...
    public com.scb.sci.customer.fm.OperationStatus1Document.OperationStatus1 getOperationStatus1()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.OperationStatus1Document.OperationStatus1)get_store().find_element_user(OPERATIONSTATUS1$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(operationStatus1, OPERATIONSTATUS1$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.OperationStatus1Document.OperationStatus1 addNewOperationStatus1()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.OperationStatus1Document.OperationStatus1 target = null;
            target = (com.scb.sci.customer.fm.OperationStatus1Document.OperationStatus1)get_store().add_element_user(OPERATIONSTATUS1$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class OperationStatus1Impl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.OperationStatus1Document.OperationStatus1
    {
        private static final long serialVersionUID = 1L;
