 ...
 */
public class ServiceLevelPriorityDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ServiceLevelPriorityDocument
{
    private static final long serialVersionUID = 1L;
    
    public ServiceLevelPriorityDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName SERVICELEVELPRIORITY$0 = 
    ...
    public com.scb.sci.customer.fm.ServiceLevelPriorityDocument.ServiceLevelPriority getServiceLevelPriority()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.ServiceLevelPriorityDocument.ServiceLevelPriority)get_store().find_element_user(SERVICELEVELPRIORITY$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(serviceLevelPriority, SERVICELEVELPRIORITY$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.ServiceLevelPriorityDocument.ServiceLevelPriority addNewServiceLevelPriority()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.ServiceLevelPriorityDocument.ServiceLevelPriority target = null;
            target = (com.scb.sci.customer.fm.ServiceLevelPriorityDocument.ServiceLevelPriority)get_store().add_element_user(SERVICELEVELPRIORITY$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ServiceLevelPriorityImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ServiceLevelPriorityDocument.ServiceLevelPriority
    {
        private static final long serialVersionUID = 1L;
