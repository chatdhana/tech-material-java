 ...
 */
public class ReferralStatusDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ReferralStatusDocument
{
    private static final long serialVersionUID = 1L;
    
    public ReferralStatusDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName REFERRALSTATUS$0 = 
    ...
    public com.scb.sci.customer.fm.ReferralStatusDocument.ReferralStatus getReferralStatus()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.ReferralStatusDocument.ReferralStatus)get_store().find_element_user(REFERRALSTATUS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(referralStatus, REFERRALSTATUS$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.ReferralStatusDocument.ReferralStatus addNewReferralStatus()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.ReferralStatusDocument.ReferralStatus target = null;
            target = (com.scb.sci.customer.fm.ReferralStatusDocument.ReferralStatus)get_store().add_element_user(REFERRALSTATUS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ReferralStatusImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ReferralStatusDocument.ReferralStatus
    {
        private static final long serialVersionUID = 1L;
