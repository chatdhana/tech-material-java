 ...
 */
public class FmProfileStatusDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.FmProfileStatusDocument
{
    private static final long serialVersionUID = 1L;
    
    public FmProfileStatusDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName FMPROFILESTATUS$0 = 
    ...
    public com.scb.sci.customer.fm.FmProfileStatusDocument.FmProfileStatus getFmProfileStatus()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.FmProfileStatusDocument.FmProfileStatus)get_store().find_element_user(FMPROFILESTATUS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(fmProfileStatus, FMPROFILESTATUS$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.FmProfileStatusDocument.FmProfileStatus addNewFmProfileStatus()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.FmProfileStatusDocument.FmProfileStatus target = null;
            target = (com.scb.sci.customer.fm.FmProfileStatusDocument.FmProfileStatus)get_store().add_element_user(FMPROFILESTATUS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class FmProfileStatusImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.FmProfileStatusDocument.FmProfileStatus
    {
        private static final long serialVersionUID = 1L;
        
        public FmProfileStatusImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
