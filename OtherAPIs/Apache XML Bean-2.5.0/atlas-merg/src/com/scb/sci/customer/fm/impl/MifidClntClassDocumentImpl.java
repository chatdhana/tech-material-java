 ...
 */
public class MifidClntClassDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.MifidClntClassDocument
{
    ...
    public com.scb.sci.customer.fm.MifidClntClassDocument.MifidClntClass getMifidClntClass()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.MifidClntClassDocument.MifidClntClass)get_store().find_element_user(MIFIDCLNTCLASS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(mifidClntClass, MIFIDCLNTCLASS$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.MifidClntClassDocument.MifidClntClass addNewMifidClntClass()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.MifidClntClassDocument.MifidClntClass target = null;
            target = (com.scb.sci.customer.fm.MifidClntClassDocument.MifidClntClass)get_store().add_element_user(MIFIDCLNTCLASS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class MifidClntClassImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.MifidClntClassDocument.MifidClntClass
    {
        private static final long serialVersionUID = 1L;
        
        public MifidClntClassImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
