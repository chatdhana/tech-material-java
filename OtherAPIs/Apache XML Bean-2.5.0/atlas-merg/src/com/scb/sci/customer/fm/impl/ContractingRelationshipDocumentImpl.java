 ...
 */
public class ContractingRelationshipDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ContractingRelationshipDocument
{
    private static final long serialVersionUID = 1L;
    
    public ContractingRelationshipDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public com.scb.sci.customer.fm.ContractingRelationshipDocument.ContractingRelationship getContractingRelationship()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.ContractingRelationshipDocument.ContractingRelationship target = null;
            target = (com.scb.sci.customer.fm.ContractingRelationshipDocument.ContractingRelationship)get_store().find_element_user(CONTRACTINGRELATIONSHIP$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setContractingRelationship(com.scb.sci.customer.fm.ContractingRelationshipDocument.ContractingRelationship contractingRelationship)
    {
        generatedSetterHelperImpl(contractingRelationship, CONTRACTINGRELATIONSHIP$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
     ...
     * This is a complex type.
     */
    public static class ContractingRelationshipImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ContractingRelationshipDocument.ContractingRelationship
    {
        private static final long serialVersionUID = 1L;
        
        public ContractingRelationshipImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
