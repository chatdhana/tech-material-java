 ...
 */
public class TransactionProcessingSystemsDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.TransactionProcessingSystemsDocument
{
    ...
    public com.scb.sci.customer.fm.TransactionProcessingSystemsDocument.TransactionProcessingSystems getTransactionProcessingSystems()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.TransactionProcessingSystemsDocument.TransactionProcessingSystems)get_store().find_element_user(TRANSACTIONPROCESSINGSYSTEMS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.scb.sci.customer.fm.TransactionProcessingSystemsDocument.TransactionProcessingSystems addNewTransactionProcessingSystems()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.TransactionProcessingSystemsDocument.TransactionProcessingSystems target = null;
            target = (com.scb.sci.customer.fm.TransactionProcessingSystemsDocument.TransactionProcessingSystems)get_store().add_element_user(TRANSACTIONPROCESSINGSYSTEMS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class TransactionProcessingSystemsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.TransactionProcessingSystemsDocument.TransactionProcessingSystems
    {
        private static final long serialVersionUID = 1L;
