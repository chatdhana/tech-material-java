 ...
 */
public class CreditGradeCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.CreditGradeCodeDocument
{
    private static final long serialVersionUID = 1L;
    
    public CreditGradeCodeDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName CREDITGRADECODE$0 = 
    ...
    public com.scb.sci.customer.fm.CreditGradeCodeDocument.CreditGradeCode getCreditGradeCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.CreditGradeCodeDocument.CreditGradeCode)get_store().find_element_user(CREDITGRADECODE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(creditGradeCode, CREDITGRADECODE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.CreditGradeCodeDocument.CreditGradeCode addNewCreditGradeCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.CreditGradeCodeDocument.CreditGradeCode target = null;
            target = (com.scb.sci.customer.fm.CreditGradeCodeDocument.CreditGradeCode)get_store().add_element_user(CREDITGRADECODE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class CreditGradeCodeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.CreditGradeCodeDocument.CreditGradeCode
    {
        private static final long serialVersionUID = 1L;
