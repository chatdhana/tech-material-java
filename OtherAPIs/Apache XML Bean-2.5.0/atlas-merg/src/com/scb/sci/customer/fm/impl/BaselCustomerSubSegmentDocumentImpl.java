 ...
 */
public class BaselCustomerSubSegmentDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.BaselCustomerSubSegmentDocument
{
    private static final long serialVersionUID = 1L;
    
    public BaselCustomerSubSegmentDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName BASELCUSTOMERSUBSEGMENT$0 = 
    ...
    public com.scb.sci.customer.fm.BaselCustomerSubSegmentDocument.BaselCustomerSubSegment getBaselCustomerSubSegment()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.BaselCustomerSubSegmentDocument.BaselCustomerSubSegment)get_store().find_element_user(BASELCUSTOMERSUBSEGMENT$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(baselCustomerSubSegment, BASELCUSTOMERSUBSEGMENT$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.BaselCustomerSubSegmentDocument.BaselCustomerSubSegment addNewBaselCustomerSubSegment()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.BaselCustomerSubSegmentDocument.BaselCustomerSubSegment target = null;
            target = (com.scb.sci.customer.fm.BaselCustomerSubSegmentDocument.BaselCustomerSubSegment)get_store().add_element_user(BASELCUSTOMERSUBSEGMENT$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class BaselCustomerSubSegmentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.BaselCustomerSubSegmentDocument.BaselCustomerSubSegment
    {
        private static final long serialVersionUID = 1L;
