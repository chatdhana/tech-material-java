 ...
 */
public class CustStatusDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.CustStatusDocument
{
    ...
    public com.scb.sci.customer.fm.CustStatusDocument.CustStatus getCustStatus()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.CustStatusDocument.CustStatus)get_store().find_element_user(CUSTSTATUS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(custStatus, CUSTSTATUS$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.CustStatusDocument.CustStatus addNewCustStatus()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.CustStatusDocument.CustStatus target = null;
            target = (com.scb.sci.customer.fm.CustStatusDocument.CustStatus)get_store().add_element_user(CUSTSTATUS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class CustStatusImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.CustStatusDocument.CustStatus
    {
        private static final long serialVersionUID = 1L;
        
        public CustStatusImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
