 ...
 */
public class AddrTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.AddrTypeDocument
{
    ...
    public com.scb.sci.customer.fm.AddrTypeDocument.AddrType getAddrType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.AddrTypeDocument.AddrType)get_store().find_element_user(ADDRTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(addrType, ADDRTYPE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.AddrTypeDocument.AddrType addNewAddrType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.AddrTypeDocument.AddrType target = null;
            target = (com.scb.sci.customer.fm.AddrTypeDocument.AddrType)get_store().add_element_user(ADDRTYPE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class AddrTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.AddrTypeDocument.AddrType
    {
        private static final long serialVersionUID = 1L;
        
        public AddrTypeImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
