 ...
 */
public class CreditGradeTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.CreditGradeTypeDocument
{
    private static final long serialVersionUID = 1L;
    
    public CreditGradeTypeDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName CREDITGRADETYPE$0 = 
    ...
    public com.scb.sci.customer.fm.CreditGradeTypeDocument.CreditGradeType getCreditGradeType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.CreditGradeTypeDocument.CreditGradeType)get_store().find_element_user(CREDITGRADETYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(creditGradeType, CREDITGRADETYPE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.CreditGradeTypeDocument.CreditGradeType addNewCreditGradeType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.CreditGradeTypeDocument.CreditGradeType target = null;
            target = (com.scb.sci.customer.fm.CreditGradeTypeDocument.CreditGradeType)get_store().add_element_user(CREDITGRADETYPE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class CreditGradeTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.CreditGradeTypeDocument.CreditGradeType
    {
        private static final long serialVersionUID = 1L;
