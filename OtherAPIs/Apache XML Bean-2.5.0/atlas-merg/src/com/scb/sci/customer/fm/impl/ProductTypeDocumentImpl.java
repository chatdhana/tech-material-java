 ...
 */
public class ProductTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ProductTypeDocument
{
    ...
    public com.scb.sci.customer.fm.ProductTypeDocument.ProductType getProductType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.ProductTypeDocument.ProductType)get_store().find_element_user(PRODUCTTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(productType, PRODUCTTYPE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.ProductTypeDocument.ProductType addNewProductType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.ProductTypeDocument.ProductType target = null;
            target = (com.scb.sci.customer.fm.ProductTypeDocument.ProductType)get_store().add_element_user(PRODUCTTYPE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ProductTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ProductTypeDocument.ProductType
    {
        private static final long serialVersionUID = 1L;
