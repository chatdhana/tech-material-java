 ...
 */
public class StatusDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.StatusDocument
{
    ...
    public com.scb.sci.customer.fm.StatusDocument.Status getStatus()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.StatusDocument.Status)get_store().find_element_user(STATUS$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.scb.sci.customer.fm.StatusDocument.Status addNewStatus()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.StatusDocument.Status target = null;
            target = (com.scb.sci.customer.fm.StatusDocument.Status)get_store().add_element_user(STATUS$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class StatusImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.StatusDocument.Status
    {
        private static final long serialVersionUID = 1L;
