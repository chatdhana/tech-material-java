 ...
 */
public class MlRiskRatingDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.MlRiskRatingDocument
{
    private static final long serialVersionUID = 1L;
    
    public MlRiskRatingDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName MLRISKRATING$0 = 
    ...
    public com.scb.sci.customer.fm.MlRiskRatingDocument.MlRiskRating getMlRiskRating()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.MlRiskRatingDocument.MlRiskRating)get_store().find_element_user(MLRISKRATING$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(mlRiskRating, MLRISKRATING$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.MlRiskRatingDocument.MlRiskRating addNewMlRiskRating()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.MlRiskRatingDocument.MlRiskRating target = null;
            target = (com.scb.sci.customer.fm.MlRiskRatingDocument.MlRiskRating)get_store().add_element_user(MLRISKRATING$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class MlRiskRatingImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.MlRiskRatingDocument.MlRiskRating
    {
        private static final long serialVersionUID = 1L;
