 ...
 */
public class MediumCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.MediumCodeDocument
{
    ...
    public com.scb.sci.customer.fm.MediumCodeDocument.MediumCode getMediumCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.MediumCodeDocument.MediumCode)get_store().find_element_user(MEDIUMCODE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(mediumCode, MEDIUMCODE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.MediumCodeDocument.MediumCode addNewMediumCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.MediumCodeDocument.MediumCode target = null;
            target = (com.scb.sci.customer.fm.MediumCodeDocument.MediumCode)get_store().add_element_user(MEDIUMCODE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class MediumCodeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.MediumCodeDocument.MediumCode
    {
        private static final long serialVersionUID = 1L;
        
        public MediumCodeImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType);
        }
