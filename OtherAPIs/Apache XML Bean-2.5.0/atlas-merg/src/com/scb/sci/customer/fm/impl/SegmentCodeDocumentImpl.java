 ...
 */
public class SegmentCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.SegmentCodeDocument
{
    private static final long serialVersionUID = 1L;
    
    public SegmentCodeDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName SEGMENTCODE$0 = 
    ...
    public com.scb.sci.customer.fm.SegmentCodeDocument.SegmentCode getSegmentCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.SegmentCodeDocument.SegmentCode)get_store().find_element_user(SEGMENTCODE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(segmentCode, SEGMENTCODE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.SegmentCodeDocument.SegmentCode addNewSegmentCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.SegmentCodeDocument.SegmentCode target = null;
            target = (com.scb.sci.customer.fm.SegmentCodeDocument.SegmentCode)get_store().add_element_user(SEGMENTCODE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class SegmentCodeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.SegmentCodeDocument.SegmentCode
    {
        private static final long serialVersionUID = 1L;
