 ...
 */
public class HierarchyTypeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.HierarchyTypeDocument
{
    ...
    public com.scb.sci.customer.fm.HierarchyTypeDocument.HierarchyType getHierarchyType()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.HierarchyTypeDocument.HierarchyType)get_store().find_element_user(HIERARCHYTYPE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(hierarchyType, HIERARCHYTYPE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.HierarchyTypeDocument.HierarchyType addNewHierarchyType()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.HierarchyTypeDocument.HierarchyType target = null;
            target = (com.scb.sci.customer.fm.HierarchyTypeDocument.HierarchyType)get_store().add_element_user(HIERARCHYTYPE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class HierarchyTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.HierarchyTypeDocument.HierarchyType
    {
        private static final long serialVersionUID = 1L;
