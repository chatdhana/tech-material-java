 ...
 */
public class ProductDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ProductDocument
{
    ...
    public com.scb.sci.customer.fm.ProductDocument.Product getProduct()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.ProductDocument.Product)get_store().find_element_user(PRODUCT$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public com.scb.sci.customer.fm.ProductDocument.Product addNewProduct()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.ProductDocument.Product target = null;
            target = (com.scb.sci.customer.fm.ProductDocument.Product)get_store().add_element_user(PRODUCT$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ProductImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ProductDocument.Product
    {
        private static final long serialVersionUID = 1L;
