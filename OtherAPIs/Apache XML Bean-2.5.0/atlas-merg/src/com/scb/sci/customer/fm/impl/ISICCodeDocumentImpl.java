 ...
 */
public class ISICCodeDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ISICCodeDocument
{
    ...
    public com.scb.sci.customer.fm.ISICCodeDocument.ISICCode getISICCode()
    {
        synchronized (monitor())
        {
            ...
            target = (com.scb.sci.customer.fm.ISICCodeDocument.ISICCode)get_store().find_element_user(ISICCODE$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    {
        generatedSetterHelperImpl(isicCode, ISICCODE$0, 0, org.apache.xmlbeans.impl.values.XmlObjectBase.KIND_SETTERHELPER_SINGLETON);
    }
    ...
    public com.scb.sci.customer.fm.ISICCodeDocument.ISICCode addNewISICCode()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.scb.sci.customer.fm.ISICCodeDocument.ISICCode target = null;
            target = (com.scb.sci.customer.fm.ISICCodeDocument.ISICCode)get_store().add_element_user(ISICCODE$0);
            return target;
        }
    }
    /**
     ...
     * This is a complex type.
     */
    public static class ISICCodeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.scb.sci.customer.fm.ISICCodeDocument.ISICCode
    {
        private static final long serialVersionUID = 1L;
